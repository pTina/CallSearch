...
},{"./searchInfo.js":"5q929"}],"5q929":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SearchInfo", ()=>SearchInfo
);
fetch("./koreaArea.json").then((response)=>{
...
class SearchInfo {
    ...
    makeArea2(val) {
        ...
        const html = `<option value="{{__val__}}">{{__val__}}</option>`;
        const listHTML = [];
        for (let item of arr)listHTML.push(html.replaceAll('{{__val__}}', item));
...
},{}]},["5vDjm","1Z4Rq"], "1Z4Rq", "parcelRequire94c2")
